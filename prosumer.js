...
class Agent{
    constructor(batteryCapacity, batteryBool){
        ...
        this.nationalGridAddress = 0; this.nationalGridPrice = 0.1; 
    ...
    async placeBuy(price, amount, date) { //request energy from market
        ...
        console.log("Ethereum Address:", this.ethereumAddress);
    ...
    async purchaseLogic() {
        // let demand = this.historicalDemand[this.timeRow].currentDemand;
        // let supply = this.historicalSupply[this.timeRow].currentSupply;
        let supply = Math.floor(Math.random() * (4901) + 100);
        let demand = Math.floor(Math.random() * (4901) + 100);
